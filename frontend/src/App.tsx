    ...
    <div className="flex flex-col">
      ...
      <main className="flex-1">
        <section className="hero-pattern relative overflow-hidden min-h-screen flex items-start pt-8 pb-24">
          <div className="container relative z-10 mx-auto px-4">
            <div className="mx-auto max-w-[800px] text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
                ...
                <span className="text-[#ff2600]">Actionable Insights</span>
              </h1>

              <p className="mb-8 text-lg text-gray-600 md:text-xl">
                CPI Dashboard helps you analyze and visualize trends in survey sampling, providing actionable insights.
              </p>
              ...
              <div className="flex justify-center">
                ...
                <SignedIn>
                  <a href="/dashboard" className="inline-flex items-center justify-center rounded-md bg-black px-6 py-3 text-base font-medium text-white hover:bg-black/90">
                    Go to Dashboard
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2">
                      <path d="M5 12h14"></path>
                      <path d="m12 5 7 7-7 7"></path>
          ...
          <img src="/3gem.png" alt="" className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] object-contain pointer-events-none" />
        </section>
      </main>
